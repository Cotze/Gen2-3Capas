<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EdicionChofer.aspx.cs" Inherits="Gen2_3Capas.Catalogos.Choferes.EdicionChofer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-col-md-12">
                <h3>Edición de chofer</h3>
            </div>
        </div>
        <div class="row">            
            <div class="col-md-12">
